...
public class ConstantUtil {
	...
	public static String NEWREACH_WEB_URL = Global.getConfig("NEWREACH_WEB_URL");
	public static String EASEMOB_MESSAGE_URL = Global.getConfig("easemob.message.url");
	public static String LIVE_APPNAME = Global.getConfig("live.AppName");
	public static String LIVE_STREAMNAME = Global.getConfig("live.StreamName");
	public static String LIVE_PRIVATEKEY = Global.getConfig("live.privatekey");
	public static String LIVE_VHOST = Global.getConfig("live.vhost");
	public static String LIVE_EFFECTIVETIME = Global.getConfig("live.effectiveTime");
}
