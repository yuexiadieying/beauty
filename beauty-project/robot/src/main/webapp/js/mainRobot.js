...
require.config({
    ...
    paths: {
        ...
        "robotFactory" : "services/robotFactory",
        "robotGlobal" : "services/robotGlobal",
        "robotDirective" : "directives/robotDirective",
        "robotRoute" : "routes/appRobotRoute",
        "appRobot" : "modules/appRobot"
    },
    waitSeconds: 0,
    shim: {
        'fullCalendar' : ['moment'],
...
require(['angular','angular-resource','angular-sanitize','ng-file-upload','ng-file-upload-shim','angular-ui-router','angular-locale_zh-cn',
        ...
        'uiBootstrapTpls','robotFactory', 'robotGlobal','robotDirective', 'robotRoute','appRobot'],
    function (angular){
