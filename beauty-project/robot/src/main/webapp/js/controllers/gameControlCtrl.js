angular.module('controllers',[]).controller('gameControlCtrl',
    ['$scope','$interval','$rootScope','$stateParams','$state','Global','$timeout','RobotUtil','GameBegin','GameStop',
        function ($scope,$interval,$rootScope,$stateParams,$state,Global,$timeout,RobotUtil,GameBegin,GameStop) {
