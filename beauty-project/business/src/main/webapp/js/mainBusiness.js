...
require.config({
    ...
    paths: {
        ...
        "businessFactory" : "services/businessFactory",
        "businessGlobal" : "services/businessGlobal",
        "businessDirective" : "directives/businessDirective",
        "businessRoute" : "routes/appBusinessRoute",
        "appBusiness" : "modules/appBusiness"
    },
    waitSeconds: 0,
    shim: {
        'moment' : ['jquery'],
...
require(['angular','angular-resource','angular-sanitize','angular-ui-router','angular-locale_zh-cn',
        ...
        'uiBootstrapTpls','businessFactory', 'businessGlobal',
        'businessDirective', 'businessRoute','appBusiness'],
    function (angular){
        angular.bootstrap(document,["businessApp"]);
    });
