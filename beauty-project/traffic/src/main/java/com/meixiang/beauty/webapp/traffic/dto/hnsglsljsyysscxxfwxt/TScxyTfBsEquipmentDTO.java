...
public class TScxyTfBsEquipmentDTO {
    ...
    **/
     ...
     *是否外协
    **/
    @JSONField(name="outsource")
    private String outsource;

    /**
     *外协数量
    **/
    @JSONField(name="outsourceNum")
    private Double outsourceNum;
    ...
    **/
    ...
    public Double getOwnerNum() {
        return ownerNum;
    }

    public void setOwnerNum(Double ownerNum) {
    ...
    public Double getOutsourceNum() {
        return outsourceNum;
    }

    public void setOutsourceNum(Double outsourceNum) {
