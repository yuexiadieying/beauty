...
public class TScxyTfBsEquipmentService {
    ...
    public List<Map<String, Object>> getTScxyTfBsEquipmentByPageable(Integer start, Integer end, String... params) {
        ...
        if (params.length <= 0) {
            ...
            tScxyTfBsEquipmentDTOs = tScxyTfBsEquipmentDao.getTScxyTfBsEquipmentByParamsPageable(start, end);
        }
    ...
    public Integer getTScxyTfBsEquipmentCount(String... params) {
        ...
        if (params.length <= 0) {
            ...
            res = tScxyTfBsEquipmentDao.getTScxyTfBsEquipmentCountByParams();
        }
        return res;
    }
}