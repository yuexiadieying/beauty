...
public class TSlyzTfBsRestudyrecordScDTO {
    ...
    private char sapplydate;

    @JSONField(name="graduatedate")
    private char graduatedate;
    ...
    public char getSapplydate() {
        return sapplydate;
    }

    public void setSapplydate(char sapplydate) {
        this.sapplydate = sapplydate;
    }

    public char getGraduatedate() {
        return graduatedate;
    }

    public void setGraduatedate(char graduatedate) {
    ...
    public char getExamresult() {
        return examresult;
    }

    public void setExamresult(char examresult) {
