...
public class TScxyTfPtPersonDTO {
    ...
    **/
     ...
     *驾驶证号
    **/
    @JSONField(name="driverCardno")
    private String driverCardno;

    /**
     *准驾车型
    **/
    @JSONField(name="driverVectype")
    private String driverVectype;

    /**
     *驾驶证初领时间
    **/
    @JSONField(name="driverFirstdate")
    ...
    **/
     ...
     *从业资格类别
    **/
    @JSONField(name="bewortype")
    private String bewortype;
    ...
    **/
     ...
     *事件规格主键ID
    **/
    @JSONField(name="repCmpsnid")
    private String repCmpsnid;
    ...
    **/
    ...
    public String getDriverVectype() {
        return driverVectype;
    }

    public void setDriverVectype(String driverVectype) {
        this.driverVectype = driverVectype;
    }
    ...
    public String getBewortype() {
        return bewortype;
    }

    public void setBewortype(String bewortype) {
        this.bewortype = bewortype;
    }
    ...
    public String getRepCmpsnid() {
        return repCmpsnid;
    }

    public void setRepCmpsnid(String repCmpsnid) {
        this.repCmpsnid = repCmpsnid;
    }
