...
public class TScxyTfBsOwnerHonorService {
    ...
    public List<Map<String, Object>> getTScxyTfBsOwnerHonorByPageable(Integer start, Integer end, String... params) {
        ...
        if (params.length <= 0) {
            ...
            tScxyTfBsOwnerHonorDTOs = tScxyTfBsOwnerHonorDao.getTScxyTfBsOwnerHonorByParamsPageable(start, end);
        }
    ...
    public Integer getTScxyTfBsOwnerHonorCount(String... params) {
        ...
        if (params.length <= 0) {
            ...
            res = tScxyTfBsOwnerHonorDao.getTScxyTfBsOwnerHonorCountByParams();
        }
        return res;
    }
}