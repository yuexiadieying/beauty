...
public class TScxyTfBsOwnerReformService {
    ...
    public List<Map<String, Object>> getTScxyTfBsOwnerReformByPageable(Integer start, Integer end, String... params) {
        ...
        if (params.length <= 0) {
            ...
            tScxyTfBsOwnerReformDTOs = tScxyTfBsOwnerReformDao.getTScxyTfBsOwnerReformByParamsPageable(start, end, params[0]);
        }
    ...
    public Integer getTScxyTfBsOwnerReformCount(String... params) {
        ...
        if (params.length <= 0) {
            ...
            res = tScxyTfBsOwnerReformDao.getTScxyTfBsOwnerReformCountByParams(params[0]);
        }
        return res;
    }
}