...
public class TScxyTfBsComplaintService {
    ...
    public List<Map<String, Object>> getTScxyTfBsComplaintByPageable(Integer start, Integer end, String... params) {
        ...
        if (params.length <= 0) {
            ...
            tScxyTfBsComplaintDTOs = tScxyTfBsComplaintDao.getTScxyTfBsComplaintByParamsPageable(start, end);
        }
    ...
    public Integer getTScxyTfBsComplaintCount(String... params) {
        ...
        if (params.length <= 0) {
            ...
            res = tScxyTfBsComplaintDao.getTScxyTfBsComplaintCountByParams();
        }
        return res;
    }
}