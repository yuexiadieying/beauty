...
public class TScxyTfBsQualityEventService {
    ...
    public List<Map<String, Object>> getTScxyTfBsQualityEventByPageable(Integer start, Integer end, String... params) {
        ...
        if (params.length <= 0) {
            ...
            tScxyTfBsQualityEventDTOs = tScxyTfBsQualityEventDao.getTScxyTfBsQualityEventByParamsPageable(start, end, params[0]);
        }
    ...
    public Integer getTScxyTfBsQualityEventCount(String... params) {
        ...
        if (params.length <= 0) {
            ...
            res = tScxyTfBsQualityEventDao.getTScxyTfBsQualityEventCountByParams(params[0]);
        }
        return res;
    }
}