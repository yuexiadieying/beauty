...
public class TScxyTfBsBusCreditRecordService {
    ...
    public List<Map<String, Object>> getTScxyTfBsBusCreditRecordByPageable(Integer start, Integer end, String... params) {
        ...
        if (params.length <= 0) {
            ...
            tScxyTfBsBusCreditRecordDTOs = tScxyTfBsBusCreditRecordDao.getTScxyTfBsBusCreditRecordByParamsPageable(start, end, params[0]);
        }
    ...
    public Integer getTScxyTfBsBusCreditRecordCount(String... params) {
        ...
        if (params.length <= 0) {
            ...
            res = tScxyTfBsBusCreditRecordDao.getTScxyTfBsBusCreditRecordCountByParams(params[0]);
        }
        return res;
    }
}