...
public class TScxyTfBsEntStabilityService {
    ...
    public List<Map<String, Object>> getTScxyTfBsEntStabilityByPageable(Integer start, Integer end, String... params) {
        ...
        if (params.length <= 0) {
            ...
            tScxyTfBsEntStabilityDTOs = tScxyTfBsEntStabilityDao.getTScxyTfBsEntStabilityByParamsPageable(start, end);
        }
    ...
    public Integer getTScxyTfBsEntStabilityCount(String... params) {
        ...
        if (params.length <= 0) {
            ...
            res = tScxyTfBsEntStabilityDao.getTScxyTfBsEntStabilityCountByParams();
        }
        return res;
    }
}