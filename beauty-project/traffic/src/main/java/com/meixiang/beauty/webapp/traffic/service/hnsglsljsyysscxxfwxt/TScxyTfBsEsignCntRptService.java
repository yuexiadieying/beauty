...
public class TScxyTfBsEsignCntRptService {
    ...
    public List<Map<String, Object>> getTScxyTfBsEsignCntRptByPageable(Integer start, Integer end, String... params) {
        ...
        if (params.length <= 0) {
            ...
            tScxyTfBsEsignCntRptDTOs = tScxyTfBsEsignCntRptDao.getTScxyTfBsEsignCntRptByParamsPageable(start, end, params[0]);
        }
    ...
    public Integer getTScxyTfBsEsignCntRptCount(String... params) {
        ...
        if (params.length <= 0) {
            ...
            res = tScxyTfBsEsignCntRptDao.getTScxyTfBsEsignCntRptCountByParams(params[0]);
        }
        return res;
    }
}