...
require.config({
    ...
    paths: {
        ...
        "carFactory" : "services/carFactory",
        "carGlobal" : "services/carGlobal",
        "carDirective" : "directives/carDirective",
        "carRoute" : "routes/appCarRoute",
        "appCar" : "modules/appCar"
    },
    waitSeconds: 0,
    shim: {
        'fullCalendar' : ['moment'],
...
require(['angular','angular-resource','angular-sanitize','ng-file-upload','ng-file-upload-shim','angular-ui-router','angular-locale_zh-cn',
        ...
        'uiBootstrapTpls','carFactory', 'carGlobal','carDirective', 'carRoute','appCar'],
    function (angular){
        angular.bootstrap(document,["carApp"]);
    });
