...
import com.meixiang.beauty.webapp.car.service.CarWeixinService;
...
public class CarWeixinController extends BaseController {
    ...
    @Autowired
    private CarWeixinService carWeixinService;
    ...
    String requestFromServer(HttpServletRequest request,HttpServletResponse response) {
          ...
          if ("GET".equals(method)) {
              ...
              respMessage = carWeixinService.processCarWeixinRequest(request,response);
              return respMessage;
          }
      }
     ...
     */
    @RequestMapping(value = "getCarWeixinMenuId", method = {RequestMethod.POST, RequestMethod.GET})
