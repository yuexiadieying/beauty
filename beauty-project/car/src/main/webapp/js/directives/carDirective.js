define(['appCar','jquery'], function (app,$) {
    app
        .directive('carMenu', ['$rootScope','$state','UserGetUser','UserLoginOut','Global','CarUtil',
            function ($rootScope,$state,UserGetUser,UserLoginOut,Global,CarUtil) {
                return {
                    restrict: 'EAC',
                    template: function(tElement,tAttrs){
                        ...
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 2"><a class="active-menu" ui-sref="index"><img src="images/index02.png">';
                        }
                        else
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 2"><a ui-sref="index"><img src="images/index01.png">';
                        }
                        _html += '首页 </a> </li>';
                        ...
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a class="active-menu" ui-sref="practitioner"><img src="images/practitioner02.png">';
                        }
                        else
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a ui-sref="practitioner"><img src="images/practitioner01.png">';
                        }
                        _html += '医护管理 </a> </li>';

                        if(tAttrs.title=='product')
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a class="active-menu" ui-sref="product"><img src="images/product02.png">';
                        }
                        else
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a ui-sref="product"><img src="images/product01.png">';
                        }
                        _html += '产品服务 </a> </li>';

                        if(tAttrs.title=='device')
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a class="active-menu" ui-sref="device"><img src="images/device02.png">';
                        }
                        else
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a ui-sref="device"><img src="images/device01.png">';
                        }
                        _html += '设备管理 </a> </li>';

                        if(tAttrs.title=='setting')
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 2 || loginUser.sysCarUserDTO.sysRoleID == 3"><a class="active-menu" ui-sref="setting"><img src="images/setting02.png">';
                        }
                        else
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 2 || loginUser.sysCarUserDTO.sysRoleID == 3"><a ui-sref="setting"><img src="images/setting01.png">';
                        }
                        _html += '机构设置 </a> </li>';

                        if(tAttrs.title=='active')
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a class="active-menu" ui-sref="active"><img src="images/device02.png">';
                        }
                        else
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a ui-sref="active"><img src="images/device01.png">';
                        }
                        _html += '活动管理 </a> </li>';

                        _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a href="javascript:;"><img src="images/device01.png">讲堂管理<span class="fa arrow"></span></a><ul id="videoMenu" class="nav nav-second-level" style="padding-left:22px;">';
                        ...
                        _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a href="javascript:;"><img src="images/device01.png">用户与权限<span class="fa arrow"></span></a><ul id="limitsMenu" class="nav nav-second-level" style="padding-left:22px;">';
                        ...
                        _html += '<li style="display:block;" ng-show="loginUser.sysCarUserDTO.sysRoleID == 1 || loginUser.sysCarUserDTO.sysRoleID == 2"><a href="javascript:;"><img src="images/device01.png">CMS<span class="fa arrow"></span></a><ul id="cmsMenu" class="nav nav-second-level" style="padding-left:22px;">';
                    ...
                    link:function(scope,ele,attrs){
                        UserGetUser.get({},function(data){
                            CarUtil.checkResponseData(data);
